...
<div class="z-10 mt-24 flex w-full flex-col sm:items-center">
	...
	<h3 class="mt-5 px-10 text-2xl font-light text-gray-800 sm:text-center md:max-w-full">Jumpstart your app development process with pre-built solutions from Neon and our community.</h3>
